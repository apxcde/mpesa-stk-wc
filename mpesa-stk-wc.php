 ...
 * Plugin URI: https://codestore.nineafrica.com/mpesa-stk-wc
 ...
 * Version: 1.0.1
 * Author URI: https://pesakite.nineafrica.com/
 *
 *
 */
...
function mpesa_row_meta( $links, $file )
{
	...
	if ( $plugin == $file ) {
		$row_meta = array(
			'github'    => '<a href="' . esc_url( 'https://github.com/pesakite/mpesa-stk-wc/' ) . '" target="_blank" aria-label="' . esc_attr__( 'Contribute on Github', 'woocommerce' ) . '">' . esc_html__( 'Github', 'woocommerce' ) . '</a>',
			...
			'pro' => '<a href="' . esc_url( 'https://codestore.nineafrica.com/mpesa-stk-wc' ) . '" target="_blank" aria-label="' . esc_attr__( 'Get Pro Version', 'woocommerce' ) . '">' . esc_html__( 'Get pro', 'woocommerce' ) . '</a>'
		 );
